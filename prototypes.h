...
/**
 * @brief Holds the items types most recent serial number and loads into the program for manipulation.
 *
 */
...
/**
 * @brief Holds the production information for each product and is loaded into proper vector.
 */
struct Product_Info {
 ...
 * @param my_Product_Info Stores the pieces of info about the new product.
